...
#[cfg(any(
    flash_c0, flash_f4, flash_g0x0, flash_g0x1, flash_g4c2, flash_g4c3, flash_g4c4, flash_h7, flash_h7ab, flash_l4
))]
mod asynch;
#[cfg(flash)]
mod common;
...
#[cfg_attr(any(flash_c0, flash_g0x0, flash_g0x1, flash_g4c2, flash_g4c3, flash_g4c4), path = "g.rs")]
